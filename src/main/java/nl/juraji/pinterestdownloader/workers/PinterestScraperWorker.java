 ...
 */
public abstract class PinterestScraperWorker<T> extends Worker<T> {
    ...
    public PinterestScraperWorker(ProgressIndicator indicator, String username, String password) {
        super(indicator);
